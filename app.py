...
UNIVERSITY_DATA = {
    ...
    "京都大学 (理系)": {
        "工学部": {
            # 二次800点: 英200, 数250, 理250(125x2), 国100
        ...
        "理学部": {
            # 二次975点: 数300, 理300(150x2), 英225, 国150
        ...
        "医学部 (医学科)": {
            # 二次1000点: 数250, 理300(150x2), 英300, 国150
        ...
        "薬学部": {
            # 二次700点: 数200, 理200(100x2), 英200, 国100
...
with col2:
    if is_science_univ:
        ...
        val_sci_total = val_sci1 + val_sci2 # 理系は200点満点分
        ...
        # 変数を統一するための処理
        val_soc_total = val_soc1 + val_soc2 # 文系は200点満点分
        val_sci_total = val_sci_base # 文系は100点満点分
...
if is_science_univ:
    ...
    # 文系: 地歴は2科目分(200)×係数、理科は1科目分(100)×係数
    # 京大文系などは地歴100点満点だが、200点入力×0.5倍係数などで調整済み
    score_soc = val_soc_total * w["soc"]
    score_sci = val_sci_total * w["sci"]
